...
############Move a bolinha#####################
##fiz os testes pra achar a pos y de cada linha de tijolos
##1o y=4, x =-28
##2o y=20 x=-44
##3o y=34  x= -58
##4o y=102   x= 152
...
MoverBola:
    ...
    addi $t8,$t8,-5		     # soma osição em y	
    addi $t7,$t7,-5 		     # soma a posição em x

    blt $t8,4,down3         # Se a bola chegar em y na posicao 37 muda o movimento
   blt $t7,-28,up3          # Se a bola chegar em x na posicao -60 muda o movimento
